...
export default class RoomFloor extends PIXI.Container {
  ...
  constructor({ floorThick, floor }) {
    ...
    //this.tileOutline = new PIXI.Sprite(Game.resources['room.tile.outline'].texture)
    //this.tileOutline.anchor.set(0.5)
  ...
  draw() {
    this._floor.forEach(tile => {
      ...
      /*roomTile.mouseover = (e) => {
        ...
        this.tileOutline.position.set(roomTile._start.X, roomTile._start.Y + 13.5)
      }*/
